...
public class Utils {
    ...
    public static String getBallerinaTypeName(GraphQLSchema graphQLSchema, String graphqlTypeName) {
        ...
        if (isCustomScalarType(graphQLSchema, graphqlTypeName)) {
            ballerinaTypeName = Constants.BALLERINA_ANYDATA_TYPE;
        } else if (isEnumType(graphQLSchema, graphqlTypeName)) {
            ballerinaTypeName = Constants.BALLERINA_STRING_TYPE;
        } else {
            switch (graphqlTypeName) {
                case Constants.GRAPHQL_ID_TYPE:
                case Constants.GRAPHQL_STRING_TYPE:
                    ballerinaTypeName = Constants.BALLERINA_STRING_TYPE;
                    break;
                case Constants.GRAPHQL_INT_TYPE:
                    ballerinaTypeName = Constants.BALLERINA_INT_TYPE;
                    break;
                case Constants.GRAPHQL_FLOAT_TYPE:
                    ballerinaTypeName = Constants.BALLERINA_FLOAT_TYPE;
                    break;
                case Constants.GRAPHQL_BOOLEAN_TYPE:
                    ballerinaTypeName = Constants.BALLERINA_BOOLEAN_TYPE;
                    break;
                default:
