...
public enum DiagnosticMessages {
    GRAPHQL_GEN_100("GRAPHQL_GEN_100", "Ballerina service code generation related error occurred.",
            DiagnosticSeverity.ERROR),
    GRAPHQL_GEN_101("GRAPHQL_GEN_101", "Ballerina service types code generation related error occurred.",
            DiagnosticSeverity.ERROR),
    ...
    GRAPHQL_GEN_105("GRAPHQL_GEN_105", "Ballerina config types code generation related error occurred.",
            DiagnosticSeverity.ERROR),
    GRAPHQL_GEN_106("GRAPHQL_GEN_106", "Ballerina code generation related error occurred.", DiagnosticSeverity.ERROR);
