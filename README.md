...
| -m, --mode                    | The `mode` parameter specifies the operation mode. It can be `client`, `schema`, `service` or `federation-gateway`. They represent Ballerina GraphQL client generation, GraphQL schema generation, Ballerina GraphQL service generation, Ballerina Graphql federation gateway generation respectively. For Ballerina GraphQL client generation and GraphQL schema generation, the `mode` parameter is optional but for Ballerina GraphQL service generation and Ballerina GraphQL federation gateway generation, it is mandatory. |
...
### Command for Ballerina GraphQL federation gateway generation

The `graphql` command for Ballerina Graphql federation gateway generation and the usages are as follows.

```
bal graphql [-i | --input] <graphql-schema-file-path> [-o | --ouput] <output-location> [-m | --mode] <operation-mode>
```


| Argument                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|-------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -i, --input                   | The `input` parameter specifies the path of the supergraph GraphQL schema file (e.g., supergraph.graphql). This parameter is mandatory.                                                                                                                                                                                                                                                                                                                                                                                            |
| -o, --output                  | The `output` parameter specifies the path of the output location of the generated Ballerina GraphQL federation gateway executable (e.g., supergraph-gateway.jar). This parameter is optional. If this parameter is not specified, the executable will be generated at the same location from which the GraphQL command is executed.                                                                                                                                                                                                |
| -m, --mode                    | The `mode` parameter specifies the operation mode. It can be `client`, `schema`, `service` or `federation-gateway`. They represent Ballerina GraphQL client generation, GraphQL schema generation, Ballerina GraphQL service generation, Ballerina Graphql federation gateway generation respectively. For Ballerina GraphQL client generation and GraphQL schema generation, the `mode` parameter is optional but for Ballerina GraphQL service generation and Ballerina GraphQL federation gateway generation, it is mandatory.  |
