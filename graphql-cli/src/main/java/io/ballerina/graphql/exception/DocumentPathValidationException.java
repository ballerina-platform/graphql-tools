 ...
 */
public class DocumentPathValidationException extends ValidationException {
    private String message;

    public DocumentPathValidationException(String message, Throwable e) {
        super(message, e);
        this.message = message;
    }

    public DocumentPathValidationException(String message) {
        super(message);
        this.message = message;
    }
    ...
    public String getDiagnosticMessage() {
        GraphqlDiagnostic graphqlDiagnostic = Utils.constructGraphqlDiagnostic(
                DiagnosticMessages.GRAPHQL_CLI_105.getCode(),
