...
public interface Generator {
    ...
    void validate()
            throws ParseException, IOException, ValidationException, SchemaFileGenerationException,
            ServiceGenerationException;

    void generate()
            throws IOException, ClientCodeGenerationException, SchemaFileGenerationException,
            ServiceGenerationException;
